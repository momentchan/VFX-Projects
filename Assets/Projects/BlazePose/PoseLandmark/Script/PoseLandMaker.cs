...
namespace BlazePose {
    public sealed class PoseLandMaker : System.IDisposable {

        #region Public
        public void ProcessImage(Texture source, ModelType modelType) => RunModel(source, modelType);
        ...
        public PoseLandMaker(PoseLandMarkResource resource, ModelType modelType) {
        ...
        private void RunModel(Texture source, ModelType modelType) {
        ...
        private void ExchangeModel(ModelType modelType) {
            selectedModelType = modelType;

            var nnModel = selectedModelType == ModelType.Lite ? resource.liteModel : resource.fullModel;
